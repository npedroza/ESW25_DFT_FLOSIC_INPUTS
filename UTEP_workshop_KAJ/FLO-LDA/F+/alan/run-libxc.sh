...
#SBATCH --job-name F- # you can give your job a name for easier identification (same as -J)
...
# cp start/FRMORB .
# cp start/RUNS .
    srun -n 4 /mnt/home/jacks1kaCMICH/PublicRelease_libxc/flosic/nrlmol_exe >&print 
 i=$[$i+1]
done
# ~/bin/cleanit
#
