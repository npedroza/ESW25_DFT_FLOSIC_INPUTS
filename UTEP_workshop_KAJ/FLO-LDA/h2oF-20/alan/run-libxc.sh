...
#SBATCH --job-name h2oF20  # you can give your job a name for easier identification (same as -J)
...
# cp start/FRMORB .
# cp start/RUNS .
    srun -n 50 /mnt/home/jacks1kaCMICH/PublicRelease_libxc/flosic/nrlmol_exe >&print 
 i=$[$i+1]
done
~/bin/cleanit
#
