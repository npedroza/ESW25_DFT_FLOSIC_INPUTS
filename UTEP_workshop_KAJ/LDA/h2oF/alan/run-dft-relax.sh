...
#SBATCH --job-name h2oF  # you can give your job a name for easier identification (same as -J)
...
# cp start/FRMORB .
# cp start/RUNS .
    srun -n 5 /mnt/home/jacks1kaCMICH/PublicRelease_libxc/flosic/nrlmol_exe >&print 
    cat FRCOUT.G0 >> HISTORY
 i=$[$i+1]
done
~/bin/cleanit
#
